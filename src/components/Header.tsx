  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/8 bg-secondary/90 text-white backdrop-blur-xl">
      <div className="border-b border-white/8 bg-white/[0.03]">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-2 px-4 py-2 text-xs text-gray-300 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-4">
            <span className="inline-flex items-center gap-2">
              <span className="accent-dot" />
              Consultas y reservas por WhatsApp en Zona Norte
            </span>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-18 items-center justify-between gap-4 py-3 lg:h-22">
          <Link href="/" className="group flex items-center gap-3 shrink-0">
            ...
            <div>
              <span className="block font-display text-2xl font-semibold leading-none text-gradient-gold lg:text-3xl">
                {EMPRESA.nombre}
              </span>
              <span className="mt-1 block text-[11px] uppercase tracking-[0.22em] text-gray-400">
      ...
      {menuOpen && (
        <div
          ...
          className="border-t border-white/8 bg-[#12131f] xl:hidden"
        >
