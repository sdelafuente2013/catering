...
const DIFFERENTIATORS = [
  {
    ...
    description:
      "Ves solo lo que hoy esta disponible, con valores base publicados y una propuesta facil de entender.",
  },
  {
...
function HeroSection({ availableImages }: { availableImages: string[] }) {
  return (
    <section className="bg-mesh-dark overflow-hidden text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-22">
        <div className="relative z-10">
          ...
          <h1 className="mt-6 max-w-4xl font-display text-4xl font-semibold leading-none text-white sm:text-5xl lg:text-6xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-300">
            ...
            con respuesta rapida, hoy puedes consultar pack grande de vasijas,
            fuente de chocolate y robot LED.
          </p>

          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/catalogo"
              className="inline-flex items-center justify-center rounded-full bg-primary px-7 py-4 text-base font-semibold text-secondary transition-all hover:-translate-y-0.5 hover:bg-primary-dark"
            >
              Ver servicios y valores base
            </Link>
            ...
            {WHATSAPP_URL ? (
              <a
                ...
                className="inline-flex items-center justify-center rounded-full border border-white/12 px-7 py-4 text-base font-semibold text-white transition-colors hover:border-primary/40 hover:bg-white/5"
              >
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-3">
            ...
            <div className="dark-panel rounded-[1.75rem] p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-300">
                La forma mas rapida de confirmar fecha, zona y cotizacion base.
              </p>
            </div>
            <div className="dark-panel rounded-[1.75rem] p-5">
              <p className="text-xs uppercase tracking-[0.2em] text-gray-500">
    ...
    <section className="section-shell py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Opciones listas para reservar hoy"
          description="Cada servicio muestra un valor base y una descripcion clara para que puedas decidir rapido y seguir por WhatsApp."
        />
    ...
    <section className="gradient-gold py-18 lg:py-22">
      <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <Link
            href="/presupuesto"
            className="inline-flex items-center justify-center rounded-full bg-secondary px-7 py-4 text-base font-semibold text-white transition-colors hover:bg-secondary/90"
          >
            Pedir propuesta
          </Link>
          {WHATSAPP_URL ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center rounded-full border border-secondary/20 px-7 py-4 text-base font-semibold text-secondary transition-colors hover:bg-secondary/8"
            >
              Hablar por WhatsApp
            </a>
          ) : (
